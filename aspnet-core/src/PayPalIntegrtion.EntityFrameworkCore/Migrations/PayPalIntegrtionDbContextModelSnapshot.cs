...
{
    [DbContext(typeof(PayPalIntegrtionDbContext))]
    partial class PayPalIntegrtionDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PayPalIntegrtion.PaymentRequests.PaymentRequest", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("PayPalIntegrtion.PaymentRequests.PaymentRequestProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PayPalIntegrtion.PaymentRequests.PaymentRequestProduct", b =>
                {
                    b.HasOne("PayPalIntegrtion.PaymentRequests.PaymentRequest", null)
                        .WithMany("Products")
